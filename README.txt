----------------------------------------------
JIRA 7.13.2-#713002 README
----------------------------------------------

Thank you for downloading JIRA 7.13.2. This distribution comes with a
...
2. Set the JAVA_HOME variable to where you installed Java. The Windows
   ...
   http://docs.atlassian.com/jira/jadm-docs-0713/Installing+Java

3. Set your JIRA Home Directory.
   Instructions on how to set your JIRA Home Directory can be found here:

   http://docs.atlassian.com/jira/jadm-docs-0713/Setting+your+JIRA+application+home+directory
...
http://docs.atlassian.com/jira/jadm-docs-0713/Installing+JIRA+applications
...
http://docs.atlassian.com/jira/jadm-docs-0713/
